...
public class abp_ms_testDbMigrationService : ITransientDependency
{
    private readonly ILogger<abp_ms_testDbMigrationService> _logger;
    private readonly ITenantRepository _tenantRepository;
    private readonly IDataSeeder _dataSeeder;
    private readonly ICurrentTenant _currentTenant;
    private readonly IUnitOfWorkManager _unitOfWorkManager;

    public abp_ms_testDbMigrationService(
        ILogger<abp_ms_testDbMigrationService> logger,
